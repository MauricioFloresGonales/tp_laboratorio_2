...
namespace Entidades
{
    public delegate void DelegadoAgregarMateria(Materia materia);
    public delegate void DelegadoAgregarAlumno(Alumnos alumno);
    public static class SistemaDeDatos
    {
        public static event DelegadoAgregarMateria eventoAgregarMateria;
        public static event DelegadoAgregarAlumno eventoAgregarAlumno;
        ...
        public static void AgregarMateria(Materia materia)
        {
            try
            {
                eventoAgregarMateria += AgregarMateriaALista;
                eventoAgregarMateria += AgregarMateriaEnBD;
                ComenzarAAgregar(materia);
            }
            catch (Exception err)
            {
                throw err;
        ...
        public static void AgregarAlumno(Alumnos alumno)
        {
            try
            {
                eventoAgregarAlumno += AgregarAlumnoiaALista;
                eventoAgregarAlumno += AgregarAlumnoEnBD;
                ComenzarAAgregar(alumno);
            }
            catch (Exception err)
            {
                throw err;
        ...
        public static void ComenzarAAgregar(Materia materia)
        {
            if (!ReferenceEquals(eventoAgregarMateria, null))
            {
                eventoAgregarMateria.Invoke(materia);
            }
        }
        public static void ComenzarAAgregar(Alumnos alumno)
        {
            if (!ReferenceEquals(eventoAgregarAlumno, null))
            {
                eventoAgregarAlumno.Invoke(alumno);
            }
        }
        public static void AgregarMateriaALista(Materia materia)
        {
            try
            {
        ...
        public static void AgregarMateriaEnBD(Materia materia)
        {
            if (object.ReferenceEquals(materia, null))
            {
                throw new Exception("la referencia al objeto materia es nula");
            }
        ...
        public static void AgregarAlumnoiaALista(Alumnos alumno)
        {
            try
            {
        ...
        public static void AgregarAlumnoEnBD(Alumnos alumno)
        {
            if (object.ReferenceEquals(alumno, null))
            {
                throw new Exception("la referencia al objeto alumno es nula");
            }
            if (!DBConexion.ConfirmarExistenciaAlumno(alumno.Id.ToString()))
            {
                ...
                foreach (Materia item in alumno.Materias)
                {
                    DBConexion.UptdateAlumnoAMaterias(item, alumno.Id);
                }
            }
        }
    }
